...
exports.createResumeEmbedding = void 0;
...
function createResumeEmbedding(resume) {
    return __awaiter(this, void 0, void 0, function () {
        var embeddings, response, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, embeddings.embedDocuments([JSON.stringify(resume)])];
                case 2:
                    response = _a.sent();
                    if (!response) {
                ...
                case 3:
                    error_1 = _a.sent();
                    console.error("Error generating embeddings:", error_1);
                    return [3 /*break*/, 4];
